...
const fullNavItems = [
  ...
  { key: '/interior', icon: <AppstoreOutlined />, label: 'Căn hộ 3D' },
...
const DashboardLayout = () => {
  ...
  const selectedKeys = useMemo(() => {
    const match = fullNavItems.find((item) => location.pathname.startsWith(item.key));
        ...
        >
          ...
          >
            ...
            <Space size={12} align="center">
              <Space direction="vertical" size={2} style={{ textAlign: 'right', lineHeight: 1 }}>
